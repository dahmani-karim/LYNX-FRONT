...
const COUNTRY_ALIASES = {
  'united states of america': ['usa', 'united states', 'us', 'états-unis', 'etats-unis', 'u.s.'],
  'united kingdom': ['uk', 'grande-bretagne', 'angleterre', 'britain', 'england'],
  france: ['france'],
  germany: ['allemagne', 'germany', 'deutschland'],
  china: ['chine', 'china'],
  'russian federation': ['russie', 'russia', 'russland'],
  japan: ['japon', 'japan'],
  'korea, republic of': ['corée du sud', 'south korea', 'korea'],
  "korea, democratic people's republic of": ['corée du nord', 'north korea'],
  ...
  egypt: ['égypte', 'egypt', 'egypte'],
  pakistan: ['pakistan'],
  bangladesh: ['bangladesh'],
  myanmar: ['myanmar', 'birmanie', 'burma'],
  ethiopia: ['éthiopie', 'ethiopia', 'ethiopie'],
  sudan: ['soudan', 'sudan'],
  venezuela: ['venezuela'],
  syria: ['syrie', 'syria'],
  ...
  indonesia: ['indonésie', 'indonesia', 'indonesie'],
